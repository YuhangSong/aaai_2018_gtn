...
\begin{figure}[ht]
	\begin{center}
		\centerline{\includegraphics[width=\columnwidth]{figure/csfg2}}%of
...
\begin{figure}
  \centering
    ...
    \includegraphics[width=.49\linewidth]{figure/figure-generalize-analysis-task}}
  \subfigure[]{
    \label{figure-generalize-analysis-epi}
    \includegraphics[width=.49\linewidth]{figure/figure-generalize-analysis-epi}}
  \caption{
...
\begin{figure}
  ...
  \subfigure[]{
    ...
    \includegraphics[width=.49\linewidth]{figure/figure-ablative-study-s}}
  \subfigure[]{
    \label{figure-ablative-study-m}
    \includegraphics[width=.49\linewidth]{figure/figure-ablative-study-m}}
